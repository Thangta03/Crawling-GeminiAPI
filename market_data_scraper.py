...
if __name__ == '__main__':
    pass
    # m = MarketDataScraper()
    # print(m.get_analysts_upgrades_downgrades_marketwatch())
    # print(m.get_vix_data())
    # print(m.get_index_data_yf())
    # print(m.get_crypto_data_yf())
    # print(m.get_next_retail_sales_report_timestamp())
    # print(m.get_next_cpi_report_timestamp())
    # print(m.get_top_losing_tickers_yf())
    # print(m.get_top_gaining_tickers_yf())
    # print(m.get_top_volume_tickers_yf())
    # print(m.get_trending_tickers_yf())
    # print(m.get_futures_data_yf())
    # print(m.get_unusual_option_volume_marketbeat())
    # print(m.get_put_call_ratio_cboe())
    # print(m.get_marketbeat_unusual_option_volume(put=True))
    # print(m.get_marketbeat_unusual_option_volume(call=True))
    # print(m.get_marketbeat_unusual_option_volume())
    # print(m.get_marketbeat_unusual_option_volume(only_calls=True))
    # print(m.get_marketbeat_unusual_option_volume(only_puts=True))
    # print(m.get_marketbeat_unusual_option_volume(put=True))
    # print(m.get_marketbeat_unusual_option_volume(call=True))

    # print(m.get_unusual_option_volume_marketbeat())
    # print(m.get_unusual_option_volume_marketbeat(only_calls=True))
    # print(m.get_unusual_option_volume_marketbeat(only_puts=True))

    # print(m.get_watchlist_yf_most_watched())
    # print(m.get_watchlist_yf_biggest_52wk_gains())
    # print(m.get_watchlist_yf_recent_52wk_highs())
    # print(m.get_watchlist_yf_biggest_52wk_losses())
    # print(m.get_watchlist_yf_most_shorted_stocks())
    # print(m.get_watchlist_yf_most_newly_added())
    # print(m.get_watchlist_yf_trending_tickers())
    # print(m.get_crypto_data_yf())
    # print(m.get_index_data_yf())
    # print(m.get_vix_data())
    # print(m.get_analysts_upgrades_downgrades_marketwatch())
